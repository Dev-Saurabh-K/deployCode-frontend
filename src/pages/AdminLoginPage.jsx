    ...
    <div className="flex min-h-screen items-center justify-center px-4 py-20">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          <div className="mb-3 inline-flex items-center gap-2 rounded-xl border-2 border-[#172a45] bg-[#e63946] px-4 py-1.5 text-xs font-black uppercase tracking-widest text-white shadow-[2px_2px_0_#172a45]">
            <Shield className="h-4 w-4" strokeWidth={2.5} />
            Restricted Area
          </div>
          <div className="mt-2 flex justify-center">
            <div className="flex h-16 w-16 items-center justify-center rounded-2xl border-2 border-[#172a45] bg-[#f6c445] shadow-[4px_4px_0_#172a45]">
              <KeyRound className="h-8 w-8 text-[#172a45]" strokeWidth={2.5} />
            </div>
          </div>
          <h1 className="mt-4 text-3xl font-black tracking-tight text-[#172a45]">
            Admin Portal
          </h1>
        ...
        <div className="card-brutal p-6 sm:p-8">
          {error && (
            <div className="mb-5 flex items-start gap-2.5 rounded-xl border-2 border-[#e63946] bg-red-100 p-3.5 text-sm font-bold text-[#e63946] shadow-[2px_2px_0_#e63946]">
          ...
          {/* Helper details */}
          <div className="mt-6 rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 p-4 text-xs font-medium text-gray-600">
